...
<script>
  ...
  export default {
    ...
    data () {
      return {
        description: '订单管理页面',
        importExcelUrl:`${window._CONFIG['domianURL']}/test/ttscoupeOrderMain/importExcel`,
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/test/ttscoupeOrderMain/list",
          delete: "/test/ttscoupeOrderMain/delete",
          deleteBatch: "/test/ttscoupeOrderMain/deleteBatch",
          exportXlsUrl: "/test/ttscoupeOrderMain/exportXls",
        }
      }
    },
    methods: {
