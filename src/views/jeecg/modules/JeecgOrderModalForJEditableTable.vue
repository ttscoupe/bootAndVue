  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          add: '/test/ttscoupeOrderMain/add',
          edit: '/test/ttscoupeOrderMain/edit',
          orderCustomerList: '/test/ttscoupeOrderMain/queryOrderCustomerListByMainId',
          orderTicketList: '/test/ttscoupeOrderMain/queryOrderTicketListByMainId'
        }
      }
    },
    created() {
